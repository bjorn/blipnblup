...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Bubble_t, stringdata) + ofs \
...
const QMetaObject Bubble::staticMetaObject = {
    { &GameObject::staticMetaObject, qt_meta_stringdata_Bubble.data,
      qt_meta_data_Bubble,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Bubble.stringdata))
